// 1. Array de palabras
const palabras = [
  "manzana", "futbol", "jardin", "telefono", "cascada",
  "bicicleta", "pintura", "computadora", "reloj", "espejo",
  "cortina", "almohada", "desierto", "montaña", "naranja",
  "estrella", "murcielago", "tigre", "elefante", "delfin",
  "guitarra", "piano", "bateria", "trueno", "relampago",
  "viento", "lluvia", "nieve", "sol", "luna",
  "océano", "bosque", "selva", "ciudad", "camino",
  "puerta", "ventana", "techo", "suelo", "pared",
  "libro", "pagina", "lapiz", "pluma", "cuaderno",
  "mesa", "silla", "lampara", "televisor", "radio",
  "coche", "autobus", "tren", "avion", "barco",
  "fruta", "verdura", "carne", "pescado", "arroz",
  "pan", "leche", "queso", "chocolate", "cafe",
  "flor", "arbol", "hoja", "raiz", "tronco",
  "animal", "insecto", "pez", "ave", "reptil",
  "huevo", "nido", "cueva", "isla", "playa"
];
...
document.querySelector("button").addEventListener("click", function () {
    ...
    for (let i = 0; i < palabraSecreta.length; i++) {
        if (letraIngresada === palabraSecreta[i]) {
            //let letraDePalabra = palabraSecreta[i];
            console.log(i)
            guiones[i].innerHTML = letraIngresada
        }
}
});
